...
$setting_admin_pass = 'minami';	 		# Admin pass (CHANGE THIS)
$setting_admin_key = '1A631BB4FDB2D5F6';			# Encryption key for sensitive data (CHANGE THIS)
...
$crypt_options = 0;  
$crypt_iv = '9D280529C5F3CE27'; ## CHANGE THIS!!! (Should be exactly 16 bytes long, may need to be in hexadecimal (contains only 0123456789abcdef) )
